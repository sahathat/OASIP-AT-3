...
<body>
  <div class="container rounded bg-white mt-1 mb-2">
    <div class="row">
        <div class="col-md-4 border-righ mt-3">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
              <img width="350" src="../assets/booking.gif">
            </div>
        </div>
        <div class="col-md-6 border-right">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2 class="text-right">Booking Appointment</h2>
                </div>
                <!-- name input -->
                <div class="row mt-2">
                    <div class="col-md-12">
                      <label class="labels fw-semibold">Name : </label>
                      <small class="float-end align-self-end"> {{ name.length }}/{{ nameLength }} charecters </small>
                      <input v-model="name" type="text" class="form-control" placeholder="Somchai Jaidee (AT-3)" required>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                      <label class="labels fw-semibold">Email : </label>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                      ...
                      <input v-model="durationTime" class="form-control" type="text" name="duration" placeholder="00" disabled>
                ...
                <div class="row mt-3">
                  <div class="col-md-7">
                    <label class="labels fw-semibold">Start Date : </label>
                ...
                <div class="row mt-3">
                  <div class="col-md-12">
                    <label class="labels fw-semibold">Note : </label>
                ...
                <div class="row mt-4">
                  <div class="col-md-12">
                    <label class="labels fw-semibold">Add File : </label>
                    <small class="float-end align-self-end">The file size cannot be larger than 10 MB.<br></small>
