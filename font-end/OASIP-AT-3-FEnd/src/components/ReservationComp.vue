        ...
        <div class="col-md-6 border-right">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2 class="text-right"> Reservation Details </h2>
                </div>
                <!-- name -->
                <div class="row mt-2">
                    <div class="col-md-12">
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" :value="`${eMail}`" disabled></div>
                </div>
                ...
                <div class="row mt-3">
                  <div class="col-md-7">
                    ...
                    <input class="form-control" type="date" :value="`${startDate}`" disabled>
                  </div>
                  <div class="col-md-5">
                    <label class="labels">Start Time : </label>
                    <input class="form-control" type="time" :value="`${startTime}`" disabled>
                  </div>
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                      ...
                      <input class="form-control" type="text" name="duration" :value="`${duration}`"  disabled>
                      <small class="fw-normal float-end d-lg-flex justify-content-lg-end">minutes</small>
                    </div>
                </div>

                <!-- note -->
                <div v-if="noteT !== null" class="row mt-3">
                  <div class="col-md-12">
                    <label class="labels">Note : </label>
                    <small class="float-end align-self-end">{{ noteT.length }}/{{ noteLength }} charecters</small>
                    <textarea class="form-control" :value="`${noteT}`" disabled></textarea>
                  </div>
                </div>

                <!-- file -->
                <div v-if="eventFile !== undefined" class="row mt-3">
                  <div class="col-md-12">
                    <label class="labels">Attachment File : </label>
                    <p class="form-control py-3"> {{ eventFile }}
                        <a :href="fileUrl" :download="id" class="float-end">
                          <box-icon name='cloud-download' size='lg' border='circle' animation='tada-hover'></box-icon>
                        </a> 
                    </p> 
                  </div>
                </div>
