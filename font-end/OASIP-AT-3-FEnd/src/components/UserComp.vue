    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                <img class="rounded-circle mt-5" width="200" height="200" src="../assets/maewzom.png">
            </div>
        </div>
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2 class="text-right">User Information</h2>
                </div>
                <div class="row mt-2">
                    <div class="col-md-12">
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                      <label class="labels fw-semibold">Role : </label>
        ...
        <div class="col-md-3 mt-3">
            <div class="p-3 py-5">
                ...
                <div class="col-md-12">
                  <label class="labels fw-semibold">Created On : </label>
                  <p class="form-control">Date : {{ formatDate(createdOn) }} , Time : {{ formatTime(createdOn) }}</p>
                </div>
                <div class="col-md-12">
                  <label class="labels fw-semibold">Updated On</label>
                  <p class="form-control"> Date : {{ formatDate(updatedOn) }} , Time : {{ formatTime(updatedOn) }}</p>
                </div>
            </div>
        </div>
        <div class="mt-2 text-center">
            ...
            <button class="btn btn-secondary" type="button" @click="goUserList">Back</button>
        </div>
    </div>
  </div>
